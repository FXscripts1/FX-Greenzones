Config = {
    Greenzones = {
        ["sspd"] = {
            location = {x = 220.44, y = -805.20, z = 30.69},
            diameter = (100 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
            ...
            restrictions = {
                ...
                speedlimit  = 200050.0, -- NOTE: Measurement is in MP/H. Change to a speed if enabled. Else change to nil to disable.
            },
            customrestrictions = {
